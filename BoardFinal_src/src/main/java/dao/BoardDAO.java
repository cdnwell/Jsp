...
public class BoardDAO {
	...
	public ArrayList<BoardCommentDTO> selectBoardComment(int bno) {
		ArrayList<BoardCommentDTO> list = new ArrayList<BoardCommentDTO>();
		String sql = "SELECT b.cno, b.bno, b.content, b.writer, b.cdate, "
				+ "(SELECT COUNT(*) FROM BOARD_COMMENT_LIKE BL WHERE BL.CNO = B.CNO) AS CLIKE, "
				+ "(SELECT COUNT(*) FROM BOARD_COMMENT_HATE BH WHERE BH.CNO = B.CNO) AS CHATE "
		...
		try {
			...
			while(rs.next()) {
				list.add(new BoardCommentDTO(rs.getInt(1), rs.getInt(2), rs.getString(3), rs.getString(4), rs.getString(5), rs.getInt(6), rs.getInt(7)));
			}
	...
	public ArrayList<BoardCommentDTO> selectBoardCommentList(int bno) {
		...
		try {
			...
			while(rs.next()) {
				list.add(new BoardCommentDTO(rs.getInt(1), rs.getInt(2), 
