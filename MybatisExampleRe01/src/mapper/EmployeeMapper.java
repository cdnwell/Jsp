...
public class EmployeeMapper {
	...
	public List<EmployeeDTO> selectDeptEmployee(String string) {
		return session.selectList("selectDeptEmployee",string);
	}
	...
	public int updateEmployeePosition() {
		return session.update("updateEmployeePosition");
	}
